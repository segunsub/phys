window.addEventListener('DOMContentLoaded', function()
{
	...
	document.querySelectorAll('.switch-group').forEach(function(switchEl) {
		switchEl.addEventListener('change', function() {
			if (this.checked) {
				document.querySelectorAll('.switch-group').forEach(function(el) {
					if (el !== switchEl) el.checked = false;
				});
			}
		});
	});
